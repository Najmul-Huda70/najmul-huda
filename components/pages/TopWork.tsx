...
import { getWorks } from "@/lib/action";
import { MoveRight } from "lucide-react";
import TopWorkSkeleton from "@/components/pages/TopWorkSkeleton";
import { Suspense } from "react";
import { RevealOnScroll, StaggerContainer, StaggerItem } from "@/components/ui/MotionWrapper";

export default async function TopWork() {
  ...
  return (
    <Suspense fallback={<TopWorkSkeleton />}>
      <section id="work" className="px-[6%] py-20 max-w-[1180px] mx-auto">
        <RevealOnScroll>
