...
export default function ProjectCard({
  ...
  return (
    <div
      ...
      className="bg-surface border border-border rounded-2xl overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:border-accent"
    >
      <div className="relative h-[170px] bg-gradient-to-br from-surface2 to-border flex items-center justify-center">
        <span className="absolute top-3 left-3 bg-black/55 text-white text-[10px] tracking-[1px] px-2.5 py-1.5 rounded-full backdrop-blur-sm">
